"""
vary number of parameters, for running supervised.

forked from mem_runner2.py, sep 21, 2021
...
def run(args):
    ...
    for arch in args.architectures:
        print(arch)
        for embedding_size in args.embedding_sizes:
            ...
            arch_result['emb_size'] = embedding_size
            fieldnames.append('emb_size')
...
def parse_args():
    ...
    parser.add_argument('--embedding-sizes', type=str, default='128,256,512,784,1024,2048', help='comma-separated')
    ...
    args.embedding_sizes = [int(v) for v in args.embedding_sizes.split(',')]
    if args.dir == 'send':
    ...
    if args.grammars != 'None':
        ...
        args.grammars = []
    args.architectures = [v for v in args.architectures.split(',') if v != '']
